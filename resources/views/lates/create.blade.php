...
<form method="post" action="{{ route('lates.store') }}" enctype="multipart/form-data">
    ...
    <div class="mb-6">
      ...
      <input type="datetime-local" id="date_time_late" name="date_time_late" class="w-full border rounded-md p-2" value="{{ old('date_time_late') }}" required autofocus>
    ...
    <div class="mb-6">
      ...
      <input type="text" id="information" name="information" class="w-full border rounded-md p-2" value="{{ old('information') }}" required autofocus>
    ...
    <div class="mb-6">
      ...
      <input type="file" id="bukti" name="bukti" class="w-full border rounded-md p-2" value="{{ old('bukti') }}" required autofocus>
