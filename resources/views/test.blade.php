...
@section('container')
    ...
    <div class="mt-4 container mx-auto">
        ...
        <div class="flex flex-wrap justify-start">
            ...
            <div class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-4">
                <div class="bg-slate-100 rounded-lg p-4 flex items-center">
                    <img src="/img/Premium Vector _ Business goals round icon illustration in thin line style.jpg" alt="Image 4" class="w-12 h-12 object-cover rounded-full mr-4">
                    <div>
            ...
            <div class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-4">
                    <div class="bg-slate-100 rounded-lg p-4 flex items-center">
                        <img src="/img/Premium Vector _ Business goals round icon illustration in thin line style.jpg" alt="Image 5" class="w-12 h-12 object-cover rounded-full mr-4">
                        <div>
